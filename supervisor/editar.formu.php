...
<head>
    ...
    <style>
        :root {
            --blanco: #ffffff;
            --verde-claro: #e0f2e9; /* Fondo verde claro */
            --verde: #4caf50; /* Verde */
            --verde-oscuro: #388e3c; /* Verde oscuro */
            --texto-primario: #1b5e20; /* Texto primario en verde oscuro */
            --texto-secundario: #66bb6a; /* Texto secundario en verde medio */
            --error: #f44336; /* Color de error */
            --gris-claro: #b0bec5; /* Gris claro */
            --rojo: #d32f2f; /* Rojo */
            --rojo-oscuro: #c62828; /* Rojo oscuro */
            --verde-primario: #66bb6a; /* Verde Primario */
            --verde-secundario: #c8e6c9; /* Verde Secundario */
            --negro: #000000; /* Negro */
        }
        ...
        * {
        ...
        body {
            ...
            background-color: var(--verde-claro); /* Fondo verde claro */
            color: var(--texto-primario); /* Color del texto en verde oscuro */
            margin: 0;
            padding: 0;
            display: flex;
        ...
        .back-button {
            display: inline-flex;
            align-items: center;
            background-color: #00766b; /* Color verde */
            color: var(--blanco);
            padding: 10px 15px;
        ...
        .back-button:hover {
            background-color: #004d40; /* Color verde oscuro al pasar el mouse */
        ...
        h1 {
            color: #004d40; /* Color del título en verde */
            text-align: center;
            margin-bottom: 20px;
        }
        ...
        label {
            font-weight: bold;
            color: #00766b; /* Color del texto de las etiquetas */
        }
        ...
        select {
            ...
            padding: 12px 15px;
            margin: 8px 0 20px 0;
            border: 1px solid var(--verde-oscuro); /* Borde verde oscuro */
            border-radius: 5px;
        ...
        select:focus {
            border-color: #00766b; /* Color del borde en foco */
            box-shadow: 0 0 5px var(--verde);
            outline: none;
        }

        .btn-submit {
            background-color: #00766b; /* Botón de color verde */
            color: var(--blanco);
            padding: 12px 20px;
            border: none;
            border-radius: 5px;
